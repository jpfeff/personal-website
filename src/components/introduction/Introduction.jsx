    ...
    <div className="intro-wrapper article-wrapper">
      ...
      <div className="contact-and-icons">
        ...
        <div className="icons">
          ...
          <a href="https://github.com/jpfeff" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/joshua-pfefferkorn/" target="_blank" rel="noopener noreferrer">
